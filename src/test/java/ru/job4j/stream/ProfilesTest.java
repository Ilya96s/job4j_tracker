...
public class ProfilesTest {
    ...
    public void whenTestMethodCollectSortWithoutDuplicate() {
        Address first = new Address("City1", "Stree1", 1, 1);
        Address second = new Address("City2", "Stree2", 2, 2);
        Address third = new Address("City3", "Stree3", 3, 3);
        Address fourth = new Address("City1", "Stree1", 1, 1);
        Address fifth = new Address("City2", "Stree2", 2, 2);
        Address sixth = new Address("City3", "Stree3", 3, 3);
        List<Profile> profiles = Arrays.asList(
                new Profile(first),
                new Profile(second),
                new Profile(third),
